...
export class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        // adding the player;
        this.player = this.physics.add.sprite(gameOptions.playerStartPosition, this.game.config.height / 2, "ground");
    ...
    addPlatform(platformWidth, posX) {
        ...
        if (this.platformPool.getLength()) {
            ...
            platform = this.physics.add.sprite(posX, this.game.config.height * 0.8, "ground");
